...
import { ChessBoardService } from '../modules/chess-board/chess-board.service';
import { BehaviorSubject } from 'rxjs';
// import { FENConverter } from 'src/app/chess-logic/FENConverter';
// import { ChessMove} from '../chess-logic/models';
...
private _stockfishService = StockfishService
        ...
        if (!this.areCoordsValid(prevX, prevY) || !this.areCoordsValid(newX, newY))
            {
                ...
                throw new Error("Coord not valid");
                return;
            }
        const piece: Piece | null = this.chessBoard[prevX][prevY];
